...
**Status:** public beta candidate, version 0.5.1. Designed for desktop Firefox and `www.dropbox.com`. Google Docs is not supported yet. Please report compatibility problems through GitHub Issues.
